...
namespace MinimalAPIBySelf.Api
{
    ...
    public class BaseApi : ControllerBase
    {
        ...
        //
        // [NonAction]
        // public async Task<ResPage<T>> GetPage<T>(ReqPage model, bool isWhere, Expression<Func<T, bool>> expression, Expression<Func<T, object>>? orderByexpression = null, OrderByType type = OrderByType.Asc)
        // {
        //     //单表分页
        //     int total = 0;//REF和OUT不支持异步,想要真的异步这是最优解
        //     // var lstQuery = db.Queryable<T>();
        //
        //     var lst = _context.Database.
        //         // await lstQuery.WhereIF(isWhere, expression)
